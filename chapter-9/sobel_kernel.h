...
"    float4 pixelValue;                                                                                \n"
"    float4 computedFilterX=0.0f;                                                                      \n"
"    float4 computedFilterY=0.0f;                                                                      \n"
...
"           computedFilterX += filter_x_grad[ifilter*windowSize+jfilter]*pixelValue;                   \n"
"           computedFilterY += filter_y_grad[ifilter*windowSize+jfilter]*pixelValue;                   \n"
"       }                                                                                              \n"
"    }                                                                                                 \n"
"                                                                                                      \n"
"    computedFilter = sqrt(computedFilterX*computedFilterX + computedFilterY*computedFilterY);         \n"
