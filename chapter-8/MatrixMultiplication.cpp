...
//"}                                                                                          \n";
//
//const char *MatrixMul_kernel_RowPerWI_APriv_BLocal1 =
//"__kernel                                                                                   \n"
//"void MatrixMul_kernel_RowPerWI_APriv_BLocal1(int dim,                                       \n"
//"                  __global float *A,                                                       \n"
//"                  __global float *B,                                                       \n"
//"                  __global float *C,                                                       \n"
//"                  __local  float *lB,                                                       \n"
...
//"                                                                                           \n"
//"    for (int k=0; k<numElements; k++)                                                      \n"
//"        lA[k*get_local_size(0) + localIDx] = A[k*get_local_size(0) + localIDx];            \n"
//"    for(int i=0; i<dim ; i++)                                                              \n"
//"    {                                                                                      \n"
//"        for (int k=0; k<numElements; k++)                                                  \n"
//"            lB[k*get_local_size(0) + localIDx] = B[(k*get_local_size(0) + localIdx) * dim + localIdx];          \n"
//"        barrier(CLK_LOCAL_MEM_FENCE);                                                      \n"
//"        for(int l=0; l<8 ; l++)                                                            \n"
//"            lA[l] = A[iRow*dim + i + l];                                                   \n"
//"        for(int j=0;j< dim;++j)                                                            \n"
...
//const char *MatrixMul_kernel_RowPerWI_APriv_BLocal1 =
//"#define w 8                                                                      \n"
//"__kernel void mul ( float *A, float *B, float *C, int m )              \n"
//"{                                                                      \n"
//"  __local float As[w][w];                                                \n"
//"  __local float Bs[w][w];                                                \n"
