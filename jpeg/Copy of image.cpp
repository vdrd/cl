	...
	case 0: // DC Table
		{
			...
			dcTableData[tableSelector].huffVal = (unsigned char *) malloc(256);// TODO: can use fwAlloc here...			
	...
	case 1: // AC Table
		{
			...
			acTableData[tableSelector].huffVal = (unsigned char *) malloc(256);// TODO: can use fwAlloc here...			
			for(unsigned long int i=0;i<count;i++)//read huff values
